...
public class MediaController extends FrameLayout {
    ...
    // My buttons
    private Button mDanmaku_switch;
    ...
    private View.OnClickListener mBackListener = new View.OnClickListener() {
        public void onClick(View v) {
            // TODO 销毁活动
            MainActivity.release((MainActivity) mContext);
        }
    };
    ...
    private OnSeekBarChangeListener mSeekListener = new OnSeekBarChangeListener() {
        ...
        public void onStopTrackingTouch(SeekBar bar) {
            if (listener != null) {
                listener.onSeek(newPosition, mPlayer.isPlaying());
            }
            if (mPlayer == null) {
                return;
            }
    ...
    private void init(Context context) {
        ...
        View viewRoot;
        if (config.getFix()) {
            viewRoot = inflater.inflate(R.layout.player_controller_fix, this);
        } else {
            viewRoot = inflater.inflate(R.layout.player_controller, this);
        }
    ...
    private void initControllerView(View v) {
        ...
        mDanmaku_switch = findViewById(R.id.danmaku_switch);
